      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 p-4">
        <Card className="w-full max-w-md shadow-2xl">
          <CardHeader>
            ...
            <CardDescription className="text-center">Sprawdź swoją skrzynkę pocztową</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <p className="text-sm text-green-800">
                Jeśli konto z adresem <strong>{state.email}</strong> istnieje, wysłaliśmy link do resetowania hasła.
              </p>
            </div>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 p-4">
      <Card className="w-full max-w-md shadow-2xl">
        <form onSubmit={handleSubmit}>
          ...
          <CardContent className="space-y-4">
            {state.error && <ErrorNotification message={state.error} title="Błąd" />}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                autoFocus
              />
              <p className="text-xs text-muted-foreground">Wprowadź email użyty przy rejestracji</p>
            </div>
          </CardContent>
