...
import { generateUniqueEmail, generateStrongPassword, clearAuth } from "../helpers/auth.helper";
...
test.describe("Scenario 1: Registration and First Login", () => {
  ...
  test("TC-AUTH-001: Should successfully register a new user", async ({ page }) => {
    ...
    const isOnProtectedPage =
      currentUrl.includes("/generate") || currentUrl.includes("/flashcards") || currentUrl.includes("/auth/register"); // Still on success screen
